...
internal val logger: SkipLogger = SkipLogger(subsystem = "yield.wise", category = "YieldWise")
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        YieldWiseAppDelegate.shared.onStart()
    }

    override fun onResume() {
        super.onResume()
        YieldWiseAppDelegate.shared.onResume()
    }

    override fun onPause() {
        super.onPause()
        YieldWiseAppDelegate.shared.onPause()
    }

    override fun onStop() {
        super.onStop()
        YieldWiseAppDelegate.shared.onStop()
    }

    override fun onDestroy() {
        super.onDestroy()
        YieldWiseAppDelegate.shared.onDestroy()
    }

    override fun onLowMemory() {
        super.onLowMemory()
        YieldWiseAppDelegate.shared.onLowMemory()
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            YieldWiseRootView().Compose(context = contentContext)
        }
    }
}
